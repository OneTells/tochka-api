...
class Transaction(Base):
    ...
    buyer_user_id: Mapped[uuid.UUID] = column(UUID(as_uuid=False), ForeignKey(User.id, ondelete="CASCADE"), nullable=False)
    seller_user_id: Mapped[uuid.UUID] = column(UUID(as_uuid=False), ForeignKey(User.id, ondelete="CASCADE"), nullable=False)

    buyer_order_id: Mapped[uuid.UUID] = column(UUID(as_uuid=False), ForeignKey(Order.id, ondelete="CASCADE"), nullable=False)
    seller_order_id: Mapped[uuid.UUID] = column(UUID(as_uuid=False), ForeignKey(Order.id, ondelete="CASCADE"), nullable=False)
